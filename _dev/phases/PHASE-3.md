...
- **İki gerçek kusur → düzeltme task'ı** (kapsam-içi; gerekçe Task Listesi'nin altındaki notta): `/gecis`'in **altı kontrast kalemi** (`01`/`02`/`03` p02 **1,21** · "Elle tutulan kayıtlar…" **3,25** · `1` **3,49** · `2` **4,23**) → **TASK-3.26** · hareket azaltma açıkken **çapa kaydırması hâlâ animasyonlu** (`html scroll-behavior: smooth` iki tercihte de; `reduce` bloğu yalnız `animation-*`/`transition-duration` sıfırlıyor) → **TASK-3.27**.
