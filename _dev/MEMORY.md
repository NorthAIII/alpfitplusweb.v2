...
**Son Güncelleme:** 2026-09-23 — TASK-2.21: hız-sınırlı-uca-batarya atomu **genelleşti** (yeni dosya açılmadı, index'e satır eklenmedi). Uçta artık ikinci bir modül-kapsamlı sayaç var — onay e-postasının adres başına tavanı — ve o da süreç boyunca yaşıyor: senaryo başına ayrı IP yetmiyor, **ayrı e-posta adresi** de gerekiyor. Ölçüldü: sabit varsayılan adres, dosyanın ortasındaki bir senaryoya ilgisiz bir kırmızı taşıdı.
