...
**Son Güncelleme:** 2026-09-23 — TASK-2.16: iddia-çapası atomu genişletildi (beşinci kural), yeni dosya açılmadı. Kapsam cümlenin **öznesinde** saklıdır: aynı olguyu anlatan iki cümleden biri ölçtüğün alanı aşar ("tarayıcı bilgisini kaydetmiyoruz" ↔ "talebinizin kaydına yazılmaz"). Olumsuz beyanda sınır daha sıkı — onu doğrulamak için her yolu ölçmen gerekir. Atomun kapsamı ürün yeteneğinden **yasal metne** de genişletildi; ikisi de "olanı" anlatmak zorunda.
