...
**Son Güncelleme:** 2026-09-22 — TASK-2.01: sunucu atomuna ölçüm sunucusunun nginx erişim kaydı eklendi (ham IP tutuluyor, saklama sınırı yok, üçüncü tarafa gitmiyor) ve ölçüm tuzağı çivilendi — Docker'ın `daemon.json` log ayarı geriye dönük değildir, konteyner oluşturulurken çözülür. Yeni atom açılmadı, index satırı eklenmedi (konu mevcut atomun kapsamında).
