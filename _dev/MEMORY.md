...
**Son Güncelleme:** 2026-09-23 — TASK-2.17: iddia-çapası atomu genişletildi (**altıncı kural**), yeni dosya açılmadı. İddianın kendisi kadar **kaynağı** da doğrulanır: devralınan bir **özet** devralınan bir iddia kadar risklidir ve tipik olarak yanlış değil **eksik** olur — TASK-2.01'in bir gün önceki *"`session` yalnız ülke/bölge/şehir"* özeti eksikti (tablo ayrıca `browser/os/device/screen/language` tutuyor) ve yasal metne olduğu gibi geçseydi yeni bir eksik beyan doğururdu. İkinci yarısı sağlayıcı ülkeleri: *nerede işliyor* ile *şirket nerede* ayrı sorulardır ve **bölge ayarı verinin evini söylemez** (v1 bu tuzağa bir kez düştü).
