...
**Son Güncelleme:** 2026-09-23 — TASK-2.20: iddia-çapası atomunun **6. kuralı** genişletildi (yeni dosya açılmadı, index'e satır eklenmedi). Devralınan özetin yanına ikinci bir biçim kondu: **task dokümanının kendi `dosya:satır` çapaları** faz ilerledikçe sessizce kayar — kimse yanlış olduğunu söylemez, yalnız yanlış satıra bakarsın. İki kez ölçüldü (TASK-2.18: eksik dal listesi · TASK-2.20: dört satır numarası da kaymış ve bir yüzey eksik sayılmış).
