...
- **Tekrarlayan bilgi yazma.** Bir bilgi tek yerde olmalı, diğer yerlerden referans ver. ⚠️ **Kanonun kendi kurduğu snapshot ikizleri bu maddenin dışındadır** — ölçütü ve bugünkü tek üyesi (DURUM'un `Task Durumu` tablosu ↔ faz dokümanının `Task Listesi`) Doküman Disiplini → Çıkarma Disiplini → *Mezuniyet yapılır*'dadır; **oraya bakmadan bir tabloyu "tekrar" diye silme.**
