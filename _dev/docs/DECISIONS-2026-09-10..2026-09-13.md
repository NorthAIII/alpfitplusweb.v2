# DECISIONS — Karar Günlüğü · 2026-09-10 .. 2026-09-13

← `DECISIONS.md` · kapanan karar aralığı

**Amaç:** `DECISIONS.md`'nin kapanmış karar aralığı — 2026-09-10 ile 2026-09-13 arasında alınan **22 karar**. Kayıtlar taşınırken değiştirilmedi; sıra (en yeni en üstte) korundu.
...
<!-- En yeni en üstte (parent ile aynı sıra) -->
