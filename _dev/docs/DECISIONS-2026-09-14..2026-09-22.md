# DECISIONS — Karar Günlüğü · 2026-09-14 .. 2026-09-22

← `DECISIONS.md` · kapanan karar aralığı

**Amaç:** `DECISIONS.md`'nin kapanmış karar aralığı — 2026-09-14 ile 2026-09-22 arasında alınan **12 karar**. Kayıtlar taşınırken değiştirilmedi; sıra (en yeni en üstte) korundu.
