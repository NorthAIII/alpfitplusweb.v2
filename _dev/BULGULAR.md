...
**Son Güncelleme:** 2026-09-23 — TASK-2.17: yasal metnin ölçüm ve aktarım beyanları ölçülene hizalandı → **B-024 kapandı ve arşive gitti** (dört kalemin dördü de bitti; hukuki dayanak ayağı B-008'de devam eder). İki yanlış iddia silindi (*"kayıtlarında IP adresinizi tutmaz"*, *"bu ölçüme kişisel verileriniz aktarılmaz"*); tedarikçi listesi 3 → 4 kaleme çıktı ve dördünün de ülkesi **bu turda kaynağından ölçüldü** (Vercel fonksiyonu `iad1`/Washington D.C. · Hetzner/DE · Resend'in kendi DPA'sı/ABD + gönderim İrlanda · ekip kutusu Google MX). Gelen Kutusu'nun nginx satırı yeniden ölçümle tazelendi. Açık bulgu sayısı 44 → **43**.
