...
- [audit-product SORU] B-056'nın izleyici koruması (`data-exclude-search="true"`, tek öznitelik, etkisi ölçüldü) **nerede** yapılsın: Umami site kimliği girilmeden hemen `/devflow:quick` ile mi, TASK-1.07'nin devamında mı? TASK-1.07'nin devamı kimliğin girilmesine bağlı; koruma kimlikten sonra gelirse arada zincir canlıdır — önerim: quick ile kimlikten önce; B-056 (b)'deki ölçüm kriteri notu TASK-1.07'nin devamında ele alınsın
