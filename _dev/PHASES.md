...
| 3 | Görsel ve mobil iyileştirme | Site 320-1440 px'te, %200-%400 büyütmede, hareket azaltma açıkken, JS kapalıyken ve yatay tutuşta bölüm bölüm gezildi ve gerçek telefonda uçtan uca tur koşuldu; ölçülmüş beş kontrast ihlali ve 320 px'te kesilen içerik kalmadı; telefonda her sayfanın ilk ekranında demoya çıkan bir yol var ve dönüşüme dokunan her hedef ≥ 44 px; kontrast ve mobil kapıları 16 sayfanın hepsini geziyor, boyanan gerçek rengi ölçüyor, ölçemediğini sayıyor ve eşik altında kırmızıya dönüyor; ana sayfanın iki kart ızgarası reddedilen kalıptan çıktı, Roller sekmeleri doğru ekranı gösteriyor, yazı tipi kümesindeki her karakterin dosyada bulunduğu doğrulandı; beş ölçüm yeşil | 🔄 Devam ediyor |
...
**Son Güncelleme:** 2026-09-23 — **Faz 3 açıldı** (discuss-phase): "Görsel ve mobil iyileştirme" Sıradaki Fazlar'dan çıkıp Faz Durumu tablosuna 🔄 olarak geçti. Kapsam devralınan üç bulgudan **dokuza** çıktı: kullanıcı B-022 · B-046 · B-051 · B-057'yi ekledi, ve B-031'in "aynı turda" uyarısı gereği B-030 ile B-012'nin a11y/mobil ayakları da alındı — kalanları "Kalite kapıları otomatik" fazında kaldı. Keşif turu fazın içinde (ekran turu başta, gerçek telefon turu sonda) ve dört yeni eksen kazandı: %200/%400 büyütme, hareket azaltma, JS kapalı, yatay tutuş.
