...
- Deploy'un nasıl yapıldığının detayı (platform ayarları, env değişkenleri) → `docs/` altındaki ilgili doküman
...
**Uzak bağlantı:** [remote adı ve URL — yoksa `yok (yerel repo)`]

| Dal | Rolü | Ortam / Hedef | Ömrü |
|-----|------|---------------|------|
| [dal adı — probe: `git branch --show-current`] | Çalışma **ve** yayın (tek dal) | [yok / URL] | Sabit |
...
**Çalışma dalı:** [yukarıdaki tablodaki dal adı] — oturumlar bu dalda çalışır.
...
- **Push:** [her commit sonrası, çalışma dalına / `yok — yerel repo, push edilmez`]
...
**Yayın hattı:** yok — çalışma dalına push doğrudan geçerlidir; ayrı bir yayın anı yoktur.
...
Ayrı rota yok — düzeltme çalışma dalında yapılır ve olağan akışla ilerler.

**Geri dönüş yönü:** tanımlı değil.
...
**Son Güncelleme:** [Tarih] — [değişikliğin tek cümle özeti, max ~250 karakter]
