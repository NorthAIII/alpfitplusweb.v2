...
| Geçiş | Tarih | Not |
|--------|-------|-----|
| Faz 1 → 2 | [tarih] | [kısa not — tek satır, max ~120 karakter] |
...
**Son Güncelleme:** [Tarih] — [son faz geçişinin tek cümle özeti, max ~250 karakter]
