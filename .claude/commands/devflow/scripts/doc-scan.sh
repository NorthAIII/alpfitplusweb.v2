...
#   TOKEN_COMFORT (6000)   rahatlık bayrağı — bu üstü üçlü teşhis: temizle/böl/supap
#                          (kanon: CLAUDE.md → Boyut ve Bölünme)
...
# birleştirip 25k token üstü tek dosya yap ve Read ile oku — PARTIAL çıktısı
# GÖSTERİLEN DİLİMİN gerçek token sayısını (N) söyler; oran = o dilimin karakter
# sayısı / N. Dosyanın sarımını değiştirme: aynı 107.382 karakter dar ve geniş
# sarımda 63.767 vs 62.198 token ölçüldü.
